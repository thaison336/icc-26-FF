...
public:
  ...
  bool begin(I2CBus *i2cBus, uint32_t i2cSpeed = 100000, uint8_t i2caddr = MAX30105_ADDRESS);
  ...
  void Max30102_setSampleRate(uint16_t sampleRate);
...
private:
  ...
  I2CBus *_m_i2cBus = nullptr;
  uint8_t fifoBuffer[288]; // 3 bytes per sample
