...
#define FSM_EVALUATE_TIMEOUT_MS (5000UL)            // 10 giây đánh giá phục hồi sau can thiệp
#define FSM_EVALUATE_INTTERVAL_ADVANCED_MS (7000UL) // 15 giây đánh giá phục hồi sau can thiệp (nâng cấp rung mạnh + BLE SOS)
