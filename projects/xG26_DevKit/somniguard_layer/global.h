...
#define AC_AMP_DROP_THRESHOLD_PCT 30.0f // % giảm biên độ PPG AC so với nền → kích phát Apnea heuristic
...
#define HAPTIC_DURATION_STRONG_MS 9000U // 9 giây – đánh thức mạnh giai đoạn 2
