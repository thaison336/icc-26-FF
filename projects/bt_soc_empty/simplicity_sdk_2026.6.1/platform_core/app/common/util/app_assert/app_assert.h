...
#if (!defined(__unix__) && defined (__arm__)) || defined (__ICCARM__)
...
// default definition for MSYS2 environments
#if !defined(_app_assert_breakpoint)
...
#if defined(__linux__) || defined(__APPLE__) || defined(_WIN32) || defined(__MSYS__)
#include <stdlib.h>
