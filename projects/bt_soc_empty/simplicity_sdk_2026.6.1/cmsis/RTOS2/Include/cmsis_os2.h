...
/* Silences "'deprecated' attribute ignored" warning.
   Remove when the `reserved` field is dropped from osThreadAttr_t. */
...
typedef struct {
  ...
  union {
    ...
    uint32_t reserved __DEPRECATED_MSG("reserved is deprecated; use affinity_mask instead");
  };
} osThreadAttr_t;
