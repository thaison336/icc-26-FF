 ...
 */
#define SX_GETBOOL(var, offset) (((var) >> (offset)) & 1)
 ...
 */
#define SX_SWAPBYTES32(word) ((((word) & 0xFF000000) >> 24) | (((word) & 0x00FF0000) >> 8) | (((word) & 0x0000FF00) << 8) | (((word) & 0x000000FF) << 24))

/** @brief Align on word boundary */
#define SX_ALIGNED __attribute__((aligned(0x4)))
