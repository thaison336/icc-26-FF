 ...
 * psa_aead_operation_s bit-fields. Pa217 fires at the access site in this
 * translation unit; suppressing inside the headers that declare the
 * bit-fields has no effect.
 */
