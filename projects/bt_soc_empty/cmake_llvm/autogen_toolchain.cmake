...
# tool on PATH
execute_process(COMMAND slt where llvm-arm-toolchain-for-embedded/21.1.1
...
if (TOOLCHAIN_SLT_PATH)
  ...
  set(DEFAULT_TOOLCHAIN_DIR "${USER_DIR}/.silabs/slt/installs/conan/p/llvm-9bf5f04ea3dd1/p/bin/")
endif ()
