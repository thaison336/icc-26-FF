...
#include "sl_simple_led_led_config.h"
#include "sl_simple_led_led0_config.h"

sl_simple_led_context_t simple_led_context = {
  .port = SL_SIMPLE_LED_LED_PORT,
  .pin = SL_SIMPLE_LED_LED_PIN,
  .polarity = SL_SIMPLE_LED_LED_POLARITY,
};

const sl_led_t sl_led_led = {
  .context = &simple_led_context,
