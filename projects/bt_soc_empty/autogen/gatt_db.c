...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_26) = {
  ...
  .max_len = 20,
  .len = 3,
  .data = { 0x53, 0x4f, 0x53, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1b, .uuid = 0x000a, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x02, .dynamicdata = &gattdb_attribute_field_26 },
